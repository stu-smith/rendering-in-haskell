...
main = do
    ...
    saveRender "output/experiment04.bmp" 640 480 $ render cam cornellBox
    putStrLn "Written output to output/experiment04.bmp"
...
cornellBox = mkScene
  ...
  where
    ...
    reflective    = addMaterials [ scaleMaterial shiny 0.3
                                 , reflectiveMaterial 0.7
                                 ]
    bitReflective = addMaterials [ scaleMaterial shiny 0.9
                                 , reflectiveMaterial 0.1
                                 ]
